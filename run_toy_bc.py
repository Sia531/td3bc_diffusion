...
for i in range(num_epochs):
    mle_agent.train(data_sampler, iterations=iterations, batch_size=batch_size)
...
for i in range(num_epochs):
    cvae_agent.train(data_sampler, iterations=iterations, batch_size=batch_size)
...
for i in range(num_epochs):
    mmd_agent.train(data_sampler, iterations=iterations, batch_size=batch_size)
